...
-- Volcando datos para la tabla rumbabar.compra_producto: ~263 rows (aproximadamente)
...
-- Volcando datos para la tabla rumbabar.producto_venta: ~645 rows (aproximadamente)
